      ...
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-12">
        <div className={cn(motion.fadeInUp)}>
          ...
          <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">
            50+ primitives, one design language
          </h2>
          <p className="mt-3 text-base leading-relaxed text-muted-foreground sm:mt-4 sm:text-lg">
            From buttons and inputs to dialogs, sidebars, and data tables — every component shares
            the same tokens, spacing, and interaction patterns.
          </p>
          <Button
            variant="outline"
            textTone="foreground"
        ...
        <Card
          className={cn(
            'overflow-hidden shadow-lg lattice-hover-lift',
            motion.fadeInUp,
            motion.stagger(2),
          )}
        >
