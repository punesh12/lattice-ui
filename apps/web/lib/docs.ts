...
export const docsConfig = {
  ...
  components: [
    ...
    { slug: 'alert-dialog', title: 'Alert Dialog', description: 'Modal dialog for destructive confirmations.' },
    ...
    { slug: 'breadcrumb', title: 'Breadcrumb', description: 'Shows the current location within a navigational hierarchy.' },
    ...
    { slug: 'command', title: 'Command', description: 'Fast, composable command menu for search and actions.' },
    { slug: 'context-menu', title: 'Context Menu', description: 'Displays a menu located at the pointer, triggered by a right-click.' },
    { slug: 'date-picker', title: 'Date Picker', description: 'A date picker component with popover calendar.' },
    { slug: 'dialog', title: 'Dialog', description: 'A window overlaid on either the primary window or another dialog window.' },
    { slug: 'modal', title: 'Modal', description: 'Centered overlay with backdrop for focused tasks and forms.' },
    { slug: 'divider', title: 'Divider', description: 'Visually or semantically separates content.' },
    { slug: 'dropdown-menu', title: 'Dropdown Menu', description: 'Displays a menu to the user triggered by a button.' },
    { slug: 'empty-state', title: 'Empty State', description: 'Placeholder for empty lists or search results.' },
    { slug: 'field', title: 'Field', description: 'Form field wrapper with label, description, and error.' },
    { slug: 'file-upload', title: 'File Upload', description: 'Drag and drop file upload zone.' },
    { slug: 'filter-bar', title: 'Filter Bar', description: 'Horizontal filter controls for lists and tables.' },
    ...
    { slug: 'notification-item', title: 'Notification Item', description: 'Single notification row for feeds.' },
    { slug: 'otp-input', title: 'OTP Input', description: 'One-time password input with paste support.' },
    { slug: 'pagination', title: 'Pagination', description: 'Pagination with page navigation and ellipsis.' },
    ...
    { slug: 'radio-group', title: 'Radio Group', description: 'A set of checkable buttons where no more than one can be checked.' },
    ...
    { slug: 'selectable-row', title: 'Selectable Row', description: 'Selectable list row for quizzes and choices.' },
    { slug: 'separator', title: 'Separator', description: 'Visually or semantically separates content.' },
    { slug: 'settings-row', title: 'Settings Row', description: 'Settings list row with label and control.' },
    { slug: 'sheet', title: 'Sheet', description: 'Extends the Dialog component to display content that complements the main content.' },
    { slug: 'sidebar', title: 'Sidebar', description: 'Collapsible application sidebar navigation.' },
    ...
    { slug: 'tag', title: 'Tag', description: 'Dismissible tag or chip for filters and selections.' },
